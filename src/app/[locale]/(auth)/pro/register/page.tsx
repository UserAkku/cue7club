...
export default function ProRegisterPage() {
  ...
  const handleSendOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        // Redirect to OTP verification page with role=PROFESSIONAL
        router.push(`/${locale}/verify-otp?email=${encodeURIComponent(email)}&role=PROFESSIONAL`);
      } else {
      ...
      <div className="flex w-full flex-col justify-center px-4 sm:px-12 lg:w-1/2 xl:px-24">
        <div className="mx-auto w-full max-w-md">
          ...
          <p className="mt-2 text-muted-foreground">
            Enter your email to start getting booked by customers.
          </p>
