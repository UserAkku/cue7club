...
import { House, GridFour, CalendarCheck, User } from "@phosphor-icons/react";
...
export function MobileBottomNav() {
  ...
  const links = [
    { href: `/${locale}`, label: "Home", icon: House },
    { href: `/${locale}/services`, label: "Services", icon: GridFour },
    { href: `/${locale}/bookings`, label: "Bookings", icon: CalendarCheck },
